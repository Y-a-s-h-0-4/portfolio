...
import srichaitanya from "../images/srichaitanya.png";
...
export const Bio = {
  ...
  description:
  "Full Stack Developer | DSA Mentor | AI & Data Enthusiast 💡💻 Passionate about crafting seamless digital experiences and solving complex problems with clean code 🚀 | Experienced in MERN stack, AI-powered solutions, and scalable web applications 🌐"
    ,
  github: "https://github.com/Y-a-s-h-0-4",
  resume:
    "https://drive.google.com/file/d/1JF2ojRGHUZDoWgAkbzM5pHwJ5ZLO4WGY/view?usp=sharing",
  ...
  
  {
    ...
    skills: [
      ...
      },
      {
        ...
        image:
          "https://static.vecteezy.com/system/resources/previews/008/681/148/non_2x/computer-network-internet-technologies-icon-vector.jpg",
      },
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Power Bi",
        image:
          "https://logohistory.net/wp-content/uploads/2023/05/Power-BI-Symbol.png",
      },
...
export const experiences = [
  {
    ...
    desc: "Guiding learners in Data Structures and Algorithms, resolving doubts, and enhancing problem-solving skills through structured mentorship.",
    skills: [
    ...
    refLink: "https://www.smartinterviews.in/",
  },
  {
    id: 1,
    img: xairotech,
    ...
    desc: "Collaborated with a team to develop and deploy a single-page application for a client, enhancing web performance and user experience.",
    skills: [
      "Framer",
      "Framer Motion",
      "React Js",
...
export const education = [
  {
    ...
    date: "November 2022 - April 2026",
    grade: "9.44 CGPA - Present",
    desc: "I am currently pursuing a Bachelor's degree in Computer Science & Engineering at VNR VJIET Engineering College, Telangana, with a GPA of 9.44. I've completed courses in  OOPS, Java, Operating Systems and Computer Networks. I'm Executive member of Turing Hut, Coding club of VNRVJIET.",
  ...
  },
  {
    ...
    grade: "94.9%",
    desc: "I completed my class 12 high school education at Sri Chaitanya College of Education,Vijaayawada, Andhra Pradesh.",
  ...
  },
  {
    ...
    img: vowel,
    school: "Vowel School",
    date: "June 2012 - August 2020",
    grade: "95.6%",
    desc: "I completed my class 10 education at Vowel School, Nellore.",
    degree: "Andhra Pradesh State Board of Secondary Education",
  },
];
